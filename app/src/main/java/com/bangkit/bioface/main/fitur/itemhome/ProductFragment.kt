...
class ProductFragment : Fragment() {
    ...
    private val herbalItems = mutableListOf<HerbalItem>() // Perbaikan tipe data

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view = inflater.inflate(R.layout.fragment_product, container, false) // Pastikan layout benar
